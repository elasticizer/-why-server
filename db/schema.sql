...
CREATE TABLE `Article` (
	...
	`Identifer` NVARCHAR(128) NOT NULL /* 識別碼 */,
...
CREATE TABLE `Category` (
	...
	`WhenCreated` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP /* 建立時間 */,
	`WhenLastEdited` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP /* 最後編輯時間 */,
	`ParentSN` INTEGER NULL REFERENCES `Category` (`SN`) ON DELETE RESTRICT ON UPDATE CASCADE /* 父項序號 */,
...
CREATE TABLE `Configuration` (
	`SN` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT /* 序號 */,
	`Key` VARCHAR(32) NOT NULL UNIQUE /* 鍵 */,
...
CREATE TABLE `Coupon` (
	...
	`DiscountRate` INTEGER NOT NULL CHECK (`DiscountRate`) /* 折扣比率 */,
	`WhenCreated` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP /* 建立時間 */,
...
CREATE TABLE `File` (
	...
	`Extension` TEXT NOT NULL /* 副檔名 */,
	`ContentType` TEXT NOT NULL /* 內容類型 */,
	`ContentHash` TEXT NOT NULL /* 內容雜湊值 */,
...
CREATE TABLE `Group` (
	`SN` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT /* 序號 */,
	`Code` VARCHAR(32) NOT NULL UNIQUE /* 代號 */,
	`Name` NVARCHAR(128) NOT NULL /* 名稱 */,
...
CREATE TABLE `OrderDetail` (
	...
	`OrderSN` TEXT NOT NULL REFERENCES `Order` (`SN`) ON DELETE RESTRICT ON UPDATE CASCADE /* 訂單序號 */,
	`LearnerSN` TEXT NOT NULL REFERENCES `User` (`SN`) ON DELETE RESTRICT ON UPDATE CASCADE /* 學員序號 */,
	`CourseSN` TEXT NOT NULL REFERENCES `Course` (`SN`) ON DELETE RESTRICT ON UPDATE CASCADE /* 課程序號 */,
...
CREATE TABLE `Staff` (
	`SN` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT /* 序號 */,
	`FirstName` NVARCHAR(64) NOT NULL /* 名字 */,
	`LastName` NVARCHAR(32) NOT NULL /* 姓氏 */,
	`Username` NVARCHAR(32) NOT NULL UNIQUE /* 使用者名稱 */,
	`PasswordHash` TEXT NULL /* 密碼雜湊值 */,
	`E-mail` TEXT NOT NULL /* 電子信箱地址 */,
	`Phone` NVARCHAR(16) NULL /* 電話號碼 */,
...
CREATE TABLE `User` (
	...
	`PasswordHash` TEXT NULL /* 密碼雜湊值 */,
	`E-mail` TEXT NOT NULL /* 電子信箱地址 */,
	`Phone` VARCHAR(16) NULL /* 電話號碼 */,
	`Nickname` TEXT NULL /* 暱稱 */,
	`Resume` TEXT NULL /* 簡歷 */,
